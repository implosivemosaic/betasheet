defmodule ClimbOntarioWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :climb_ontario
  ...
  @session_options [
    store: :cookie,
    key: "_climb_ontario_key",
    signing_salt: "I5RHHOy6",
    same_site: "Lax"
  ]
  ...
  plug Plug.Static,
    ...
    only: ClimbOntarioWeb.static_paths(),
